...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'hyasin';//this will be your WCC username
      $dbUsr = 'hyasin';//this will be your WCC username
      $dbPass = '2styEBRHpHTvdnr';//this will be the password found in the video.
